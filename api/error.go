...
var (
	...
	errNotExists     = echo.NewHTTPError(404, httpErr{203, "no such file of directiry"})
	errIsNotDir      = echo.NewHTTPError(400, httpErr{204, "is not directory"})
	errInsufficient  = echo.NewHTTPError(400, httpErr{205, "space is insufficient"})
	errExists        = echo.NewHTTPError(400, httpErr{206, "already exists"})
)
